...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
                        ...
                        <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4"
                         ...
                         <?php
                            ...
                            if(isset( $_SESSION['login_user'])){
                                echo "<li><a class='inline-block no-underline hover:text-black hover:underline py-2 px-4'
                                href='#'>Hello ". $_SESSION['login_user']."</a></li>";
                            } else {
                                echo "";
                            }
        ...
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item absolute opacity-0" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url('https://wallpapercave.com/wp/wp3537545.jpg');">

                    <div class="container mx-auto">
                        <div
                            class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                            <p class="text-white text-3xl my-4">E-Commerce</p>
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-right" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url('https://odysseyteams.com/wp-content/uploads/2022/12/help-5.png;">

                    <div class="container mx-auto">
                        <div
                            class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                            <p class="text-black text-3xl my-4">Philanthropy</p>
                            <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black"
                                href="#"></a>
                        </div>
                    </div>
            ...
            <div class="carousel-item absolute opacity-0" style="height:50vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-bottom"
                    ...
                    <div class="container mx-auto">
                        <div
                            class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                            <p class="text-black text-3xl my-4">Universal</p>
                            <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black"
                                href="#"></a>
                        </div>
                    </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="product_details.php?id=1">
                    ...
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">E-Commerce Store | Healthy & Beauty</p>
                        <?php
                        // Connect to your database
                        include 'config.php';

                        // Query to get total sales for product with id=1
                        $sql = "SELECT COUNT(order_id) AS total_sales FROM orders WHERE product_id = 1";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $total_sales = $row['total_sales'];

                        // Display total sales
                        echo "<p class='text-gray-900'>Rp. 300,000 - Total Sales: $total_sales</p>";    
                        ?>
                    </div>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="product_details.php?id=2">
                    <img class="hover:grow hover:shadow-lg"
                        src="assets\web2.png">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">Gym Promotional Website</p>
                        <?php
                        $sql = "SELECT COUNT(order_id) AS total_sales FROM orders WHERE product_id = 2";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $total_sales = $row['total_sales'];
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="product_details.php?id=3">
                    <img class="hover:grow hover:shadow-lg"
                        src="assets\web3.png">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">Dogfood Ready-made Website</p>
                        <?php
                        $sql = "SELECT COUNT(order_id) AS total_sales FROM orders WHERE product_id = 3";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $total_sales = $row['total_sales'];
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="product_details.php?id=4">
                    <img class="hover:grow hover:shadow-lg"
                        src="assets\web4.png">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">Wedding Website</p>
                        <?php
                        $sql = "SELECT COUNT(order_id) AS total_sales FROM orders WHERE product_id = 4";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $total_sales = $row['total_sales'];

                        // Display total sales
                        echo "<p class='text-gray-900'>Rp. 300,000 - <br>Total Sales: $total_sales</p>";
                        ?>
                    </div>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="product_details.php?id=5">
                    <img class="hover:grow hover:shadow-lg"
                        src="assets\web5.png">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">Travel Website</p>
                        <?php
                        $sql = "SELECT COUNT(order_id) AS total_sales FROM orders WHERE product_id = 5";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $total_sales = $row['total_sales'];
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="product_details.php?id=6">
                    <img class="hover:grow hover:shadow-lg"
                        src="assets/web6.png">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">Restaruant Website</p>
                        <?php
                        $sql = "SELECT COUNT(order_id) AS total_sales FROM orders WHERE product_id = 6";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $total_sales = $row['total_sales'];
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="product_details.php?id=7">
                    <img class="hover:grow hover:shadow-lg"
                        src="assets\web7.png">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">Charity Website</p>
                        <?php
                        $sql = "SELECT COUNT(order_id) AS total_sales FROM orders WHERE product_id = 7";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $total_sales = $row['total_sales'];
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="product_details.php?id=8">
                    <img class="hover:grow hover:shadow-lg"
                        src="assets\web8.png">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">One Page Website</p>
                        <?php
                        $sql = "SELECT COUNT(order_id) AS total_sales FROM orders WHERE product_id = 8";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $total_sales = $row['total_sales'];
    ...
    <section class="bg-white py-8">
        ...
        <div class="container py-8 px-6 mx-auto">
            ...
            <p class="mb-8">Welcome to our platform, where your quest for the perfect website ends. Say goodbye to the daunting task
                            ...
                            layouts, we have something to suit every taste and purpose.</p>
            ...
            <div class="w-full mx-auto flex flex-wrap">
                <div class="flex w-full lg:w-1/2 ">
                    <div class="px-3 md:px-0">
                        ...
                        <p class="py-4">
                            Open 24 hours a day. Ready to provide all your necessity with outmost standard.
                        </p>
                    </div>
                </div>
