        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="product.php" class="waves-effect <?php if($title=='product'){echo 'active';} ?>"><i class="fa fa-suitcase fa-fw" aria-hidden="true"></i> Products</a>
                    </li>
                    <li>
                        <a href="ap.php" class="waves-effect <?php if($title=='ap'){echo 'active';} ?>"><i class="fa fa-archive fa-fw" aria-hidden="true"></i> Account Payable</a>
                    </li>
                    <li>
                        <a href="transaksi.php" class="waves-effect"><i class="fa fa-shopping-cart fa-fw" aria-hidden="true"></i> Received Material</a>
                    </li>
                    <li>
                        <a href="laporan.php" class="waves-effect <?php if($title=='laporan'){echo 'active';}?>"><i class="fa fa-file-text fa-fw" aria-hidden="true"></i> Cash Out Record</a>
                    </li>
                </ul>
